...
<Jargon items={[
  ['passkey', 'de publieksnaam voor deze manier van inloggen'],
...
<Kort>dezelfde ring, maar gegoten in metaal en nergens gekopieerd. Het geheim zit in de chip en kan er fysiek niet uit. Ook niet door jou.</Kort>
...
<Jargon items={[
  ['security key', 'de officiële naam voor zo\'n los stukje hardware, bijvoorbeeld een YubiKey'],
